...
export default function Stats() {
  ...
  return (
    <section className="bg-white py-12 transition-colors duration-300 dark:bg-brand-navy">
      <div className="section-shell grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {stats.map((stat) => (
          <div key={stat.label} className="rounded-[1.75rem] border border-slate-200 bg-slate-50 p-6 text-center shadow-sm transition hover:-translate-y-1 hover:border-sky-200 hover:shadow-soft dark:border-white/10 dark:bg-brand-card">
